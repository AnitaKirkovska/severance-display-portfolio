...
const Index = () => {
  ...
  const letterPositions: LetterPosition[] = [
    ...
    { row: 2, col: 8, letter: 'M', buttonId: 'about' },
    { row: 2, col: 9, letter: 'E', buttonId: 'about' },
    
    { row: 6, col: 2, letter: 'L', buttonId: 'linkedin' },
    { row: 6, col: 3, letter: 'I', buttonId: 'linkedin' },
    { row: 6, col: 4, letter: 'N', buttonId: 'linkedin' },
    { row: 6, col: 5, letter: 'K', buttonId: 'linkedin' },
    { row: 6, col: 6, letter: 'E', buttonId: 'linkedin' },
    { row: 6, col: 7, letter: 'D', buttonId: 'linkedin' },
    { row: 6, col: 8, letter: 'I', buttonId: 'linkedin' },
    { row: 6, col: 9, letter: 'N', buttonId: 'linkedin' },
    
    { row: 10, col: 2, letter: 'A', buttonId: 'article' },
    { row: 10, col: 3, letter: 'R', buttonId: 'article' },
    { row: 10, col: 4, letter: 'T', buttonId: 'article' },
    { row: 10, col: 5, letter: 'I', buttonId: 'article' },
    { row: 10, col: 6, letter: 'C', buttonId: 'article' },
    { row: 10, col: 7, letter: 'L', buttonId: 'article' },
    { row: 10, col: 8, letter: 'E', buttonId: 'article' },
    
    { row: 14, col: 2, letter: 'P', buttonId: 'project' },
    { row: 14, col: 3, letter: 'R', buttonId: 'project' },
    { row: 14, col: 4, letter: 'O', buttonId: 'project' },
    { row: 14, col: 5, letter: 'J', buttonId: 'project' },
    { row: 14, col: 6, letter: 'E', buttonId: 'project' },
    { row: 14, col: 7, letter: 'C', buttonId: 'project' },
    { row: 14, col: 8, letter: 'T', buttonId: 'project' },
    
    { row: 18, col: 2, letter: 'V', buttonId: 'video' },
    { row: 18, col: 3, letter: 'I', buttonId: 'video' },
    { row: 18, col: 4, letter: 'D', buttonId: 'video' },
    { row: 18, col: 5, letter: 'E', buttonId: 'video' },
    { row: 18, col: 6, letter: 'O', buttonId: 'video' },
    
    { row: 22, col: 2, letter: 'B', buttonId: 'call' },
    { row: 22, col: 3, letter: 'O', buttonId: 'call' },
    { row: 22, col: 4, letter: 'O', buttonId: 'call' },
    { row: 22, col: 5, letter: 'K', buttonId: 'call' },
    { row: 23, col: 2, letter: 'C', buttonId: 'call' },
    { row: 23, col: 3, letter: 'A', buttonId: 'call' },
    { row: 23, col: 4, letter: 'L', buttonId: 'call' },
    { row: 23, col: 5, letter: 'L', buttonId: 'call' },
  ];
