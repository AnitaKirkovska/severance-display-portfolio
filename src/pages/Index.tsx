...
const Index = () => {
  ...
  const letterPositions: LetterPosition[] = [
    ...
    { row: 6, col: 2, letter: 'L', buttonId: 'article' },
    { row: 6, col: 3, letter: 'A', buttonId: 'article' },
    { row: 6, col: 4, letter: 'T', buttonId: 'article' },
    { row: 6, col: 5, letter: 'E', buttonId: 'article' },
    { row: 6, col: 6, letter: 'S', buttonId: 'article' },
    { row: 6, col: 7, letter: 'T', buttonId: 'article' },
    ...
    { row: 23, col: 2, letter: 'N', buttonId: 'project' },
    { row: 23, col: 3, letter: 'E', buttonId: 'project' },
    { row: 23, col: 4, letter: 'W', buttonId: 'project' },
    { row: 23, col: 6, letter: 'P', buttonId: 'project' },
    { row: 23, col: 7, letter: 'R', buttonId: 'project' },
    { row: 23, col: 8, letter: 'O', buttonId: 'project' },
    
    { row: 26, col: 2, letter: 'N', buttonId: 'video' },
    { row: 26, col: 3, letter: 'O', buttonId: 'video' },
    { row: 26, col: 4, letter: 'W', buttonId: 'video' },
    { row: 26, col: 6, letter: 'V', buttonId: 'video' },
    { row: 26, col: 7, letter: 'I', buttonId: 'video' },
    { row: 26, col: 8, letter: 'D', buttonId: 'video' },
    
    { row: 28, col: 2, letter: 'M', buttonId: 'call' },
    { row: 28, col: 3, letter: 'E', buttonId: 'call' },
