...
const Index = () => {
  ...
  const letterPositions: LetterPosition[] = [
    ...
    { row: 8, col: 4, letter: 'L', buttonId: 'linkedin' },
    { row: 9, col: 7, letter: 'I', buttonId: 'linkedin' },
    { row: 10, col: 5, letter: 'N', buttonId: 'linkedin' },
    { row: 8, col: 8, letter: 'K', buttonId: 'linkedin' },
    { row: 11, col: 6, letter: 'E', buttonId: 'linkedin' },
    { row: 9, col: 4, letter: 'D', buttonId: 'linkedin' },
    { row: 10, col: 8, letter: 'I', buttonId: 'linkedin' },
    { row: 11, col: 3, letter: 'N', buttonId: 'linkedin' },
    ...
    { row: 18, col: 6, letter: 'P', buttonId: 'project' },
    { row: 19, col: 4, letter: 'R', buttonId: 'project' },
    { row: 17, col: 7, letter: 'O', buttonId: 'project' },
    { row: 18, col: 3, letter: 'J', buttonId: 'project' },
    { row: 19, col: 8, letter: 'E', buttonId: 'project' },
    { row: 17, col: 5, letter: 'C', buttonId: 'project' },
    { row: 20, col: 6, letter: 'T', buttonId: 'project' },
    ...
    { row: 25, col: 4, letter: 'B', buttonId: 'call' },
    { row: 24, col: 6, letter: 'O', buttonId: 'call' },
    { row: 26, col: 5, letter: 'O', buttonId: 'call' },
    { row: 25, col: 7, letter: 'K', buttonId: 'call' },
    { row: 24, col: 3, letter: 'C', buttonId: 'call' },
    { row: 26, col: 8, letter: 'A', buttonId: 'call' },
    { row: 25, col: 5, letter: 'L', buttonId: 'call' },
    { row: 24, col: 7, letter: 'L', buttonId: 'call' },
  ];
