...
const Index = () => {
  ...
  const letterPositions: LetterPosition[] = [
    { row: 4, col: 3, letter: 'A', buttonId: 'about' },
    { row: 4, col: 8, letter: 'B', buttonId: 'about' },
    { row: 3, col: 5, letter: 'O', buttonId: 'about' },
    { row: 5, col: 6, letter: 'U', buttonId: 'about' },
    { row: 3, col: 7, letter: 'T', buttonId: 'about' },
    { row: 5, col: 4, letter: 'M', buttonId: 'about' },
    { row: 4, col: 6, letter: 'E', buttonId: 'about' },
    
    { row: 8, col: 22, letter: 'L', buttonId: 'linkedin' },
    { row: 9, col: 25, letter: 'I', buttonId: 'linkedin' },
    { row: 10, col: 23, letter: 'N', buttonId: 'linkedin' },
    { row: 8, col: 26, letter: 'K', buttonId: 'linkedin' },
    { row: 11, col: 24, letter: 'E', buttonId: 'linkedin' },
    { row: 9, col: 22, letter: 'D', buttonId: 'linkedin' },
    { row: 10, col: 26, letter: 'I', buttonId: 'linkedin' },
    { row: 11, col: 21, letter: 'N', buttonId: 'linkedin' },
    
    { row: 13, col: 7, letter: 'A', buttonId: 'article' },
    { row: 14, col: 5, letter: 'R', buttonId: 'article' },
    { row: 15, col: 8, letter: 'T', buttonId: 'article' },
    { row: 13, col: 4, letter: 'I', buttonId: 'article' },
    { row: 15, col: 6, letter: 'C', buttonId: 'article' },
    { row: 14, col: 3, letter: 'L', buttonId: 'article' },
    { row: 16, col: 5, letter: 'E', buttonId: 'article' },
    
    { row: 18, col: 24, letter: 'P', buttonId: 'project' },
    { row: 19, col: 22, letter: 'R', buttonId: 'project' },
    { row: 17, col: 25, letter: 'O', buttonId: 'project' },
    { row: 18, col: 21, letter: 'J', buttonId: 'project' },
    { row: 19, col: 26, letter: 'E', buttonId: 'project' },
    { row: 17, col: 23, letter: 'C', buttonId: 'project' },
    { row: 20, col: 24, letter: 'T', buttonId: 'project' },
    
    { row: 22, col: 7, letter: 'V', buttonId: 'video' },
    { row: 21, col: 5, letter: 'I', buttonId: 'video' },
    { row: 23, col: 8, letter: 'D', buttonId: 'video' },
    { row: 22, col: 4, letter: 'E', buttonId: 'video' },
    { row: 21, col: 6, letter: 'O', buttonId: 'video' },
    
    { row: 25, col: 22, letter: 'B', buttonId: 'call' },
    { row: 24, col: 24, letter: 'O', buttonId: 'call' },
    { row: 26, col: 23, letter: 'O', buttonId: 'call' },
    { row: 25, col: 25, letter: 'K', buttonId: 'call' },
    { row: 24, col: 21, letter: 'C', buttonId: 'call' },
    { row: 26, col: 26, letter: 'A', buttonId: 'call' },
    { row: 25, col: 23, letter: 'L', buttonId: 'call' },
    { row: 24, col: 25, letter: 'L', buttonId: 'call' },
  ];
